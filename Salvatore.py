...
class Salvatore(StateMachineProgram):
    ...
    def setup(self):
        ...
        datatrans37 .add_sources(parse_player_move) .add_destinations(narrate_player_move)
        
        datatrans38 = DataTrans('need_side') .set_name("datatrans38")
        datatrans38 .add_sources(parse_player_move) .add_destinations(domino_need_side)
        
        datatrans39 = DataTrans('end_game') .set_name("datatrans39")
        datatrans39 .add_sources(parse_player_move) .add_destinations(domino_exit)
        
        datatrans40 = DataTrans('blocked') .set_name("datatrans40")
        datatrans40 .add_sources(parse_player_move) .add_destinations(domino_blocked_game_over_prompt)
        
        datatrans41 = DataTrans('new_game') .set_name("datatrans41")
        datatrans41 .add_sources(parse_player_move) .add_destinations(domino_restart)
        
        datatrans42 = DataTrans('misc') .set_name("datatrans42")
        datatrans42 .add_sources(parse_player_move) .add_destinations(domino_misc_player_move)
        
        datatrans43 = DataTrans('illegal') .set_name("datatrans43")
        datatrans43 .add_sources(parse_player_move) .add_destinations(normalize_illegal_domino_move)
        ...
        datatrans44 = DataTrans('resolved') .set_name("datatrans44")
        datatrans44 .add_sources(parse_player_side) .add_destinations(narrate_player_move)
        
        datatrans45 = DataTrans('end_game') .set_name("datatrans45")
        datatrans45 .add_sources(parse_player_side) .add_destinations(domino_exit)
        
        datatrans46 = DataTrans('new_game') .set_name("datatrans46")
        datatrans46 .add_sources(parse_player_side) .add_destinations(domino_restart)
        
        datatrans47 = DataTrans('misc') .set_name("datatrans47")
        datatrans47 .add_sources(parse_player_side) .add_destinations(domino_misc_player_side)
        
        datatrans48 = DataTrans('illegal') .set_name("datatrans48")
        datatrans48 .add_sources(parse_player_side) .add_destinations(normalize_illegal_domino_move)
        ...
        datatrans49 .add_sources(normalize_illegal_domino_move) .add_destinations(domino_misc_player_move)
        
        datatrans50 = DataTrans('misc') .set_name("datatrans50")
        datatrans50 .add_sources(parse_illegal_domino_move) .add_destinations(domino_misc_player_move)
        ...
        datatrans51 = DataTrans('teach') .set_name("datatrans51")
        datatrans51 .add_sources(check_teach_after_player_move) .add_destinations(prompt_move_teaching_followup_player)
        
        datatrans52 = DataTrans('skip') .set_name("datatrans52")
        datatrans52 .add_sources(check_teach_after_player_move) .add_destinations(say_domino_board_player)
        ...
        datatrans53 = DataTrans('say') .set_name("datatrans53")
        datatrans53 .add_sources(parse_move_teaching_followup_player) .add_destinations(say_move_teaching_followup_player)
        
        datatrans54 = DataTrans('skip') .set_name("datatrans54")
        datatrans54 .add_sources(parse_move_teaching_followup_player) .add_destinations(say_domino_board_player)
        ...
        datatrans55 = DataTrans('resolved') .set_name("datatrans55")
        datatrans55 .add_sources(domino_celeste_turn) .add_destinations(narrate_celeste_move)
        ...
        datatrans56 = DataTrans('teach') .set_name("datatrans56")
        datatrans56 .add_sources(check_teach_after_celeste_move) .add_destinations(prompt_move_teaching_followup_celeste)
        
        datatrans57 = DataTrans('skip') .set_name("datatrans57")
        datatrans57 .add_sources(check_teach_after_celeste_move) .add_destinations(say_domino_board_celeste)
        ...
        datatrans58 = DataTrans('say') .set_name("datatrans58")
        datatrans58 .add_sources(parse_move_teaching_followup_celeste) .add_destinations(say_move_teaching_followup_celeste)
        
        datatrans59 = DataTrans('skip') .set_name("datatrans59")
        datatrans59 .add_sources(parse_move_teaching_followup_celeste) .add_destinations(say_domino_board_celeste)
